    ...
    <div className="h-screen py-20 px-96">
      ...
      <div className="w-full h-full my-auto flex lg:flex-col items-center justify-center gap-x-20 lg:gap-x-0 lg:gap-y-20">
        <motion.div initial={{opacity:0,y:150}} whileInView={{opacity:1, y:0}} transition={{duration:0.5}} viewport={{once:true}} >
          ...
          <motion.form initial={{opacity:0,x:150}} whileInView={{opacity:1, x:0}} transition={{duration:0.5}} viewport={{once:true}} className="w-[600px] lg:w-[400px] sm:w-full flex flex-col gap-3 lg:gap-y-3">
            <div className= "w-full flex lg:flex-col gap-3 lg:gap-y-3">
              ...
              <input type="submit" className="w-full border border-yellow-500 bg-yellow-600 rounded-md px-4 py-2 text-sm font-light tracking-wider text-white outline-none hover:bg-yellow-500 transition-colors cursor-pointer" value='Send Message' />
